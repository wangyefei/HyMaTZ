...
class MainWindow(QMainWindow):
    ...
    def __init__(self,parent=None):
        ...
        self.CheckRegression=[False,False,False]
    ...
    def BTN_Minerals(self):
        ...
        i+=1
        self.label = QLabel()
        self.label.setText("1. Select a compositional model and click ‘Load Model’. To create a layered model, click the checkbox at right")
        ...
        self.BTN_choice.setText('Load Model')
        ...
        i+=1
        self.label = QLabel()
        self.label.setText('2. Enter the potential temperature for the mantle adiabat')
        self.label.setWordWrap(True)
...
#==============================================================================
        ...
        self.label.setText('3. Calculate and display the model phase proportions')
        self.label.setWordWrap(True)
        self.BTN_Minerals_layout.addWidget(self.label,i,0,1,6)

        i+=1
        self.Calculate_Button=QPushButton()
        self.Calculate_Button.setText('Click to calculate and display phase proportions')
        ...
        self.label = QLabel()
        self.label.resize(100,50)
        self.label.setText('Use the pull down to view or modify elastic properties for each hydrated phase')
        self.label.setWordWrap(True)
        self.BTN_Minerals_layout.addWidget(self.label,i,0,1,6)
        ...
        i+=1
        self.label = QLabel()
        self.label.setText('5. Define water content profile')
        self.label.setWordWrap(True)
        self.BTN_Minerals_layout.addWidget(self.label,i,0,1,6)

        i+=1
        self.BTN_water = QPushButton()
        self.BTN_water.setText('Click to Set the Water Content Profile ')
        ...
        i+=1
        self.label = QLabel()
        self.label.setText('6. Use customized Fo# for olivine, wadsleyite, or ringwoodite. The box at right must be checked')
        self.label.setWordWrap(True)
        self.BTN_Minerals_layout.addWidget(self.label,i,0,1,5)
        ...
        self.BTN_iron.setText('Click to Change the Fo# ')
        ...
        self.label = QLabel()
        self.label.resize(100,50)
        self.label.setText('7. Select a polycrystalline averaging scheme')
        self.label.setWordWrap(True)
        self.BTN_Minerals_layout.addWidget(self.label,i,0,1,6)
        ...
        self.label = QLabel()
        self.label.resize(100,50)
        self.label.setText('8. Calculate Vp and Vs. Check the box at right to input an attenuation model')
        self.label.setWordWrap(True)
        self.BTN_Minerals_layout.addWidget(self.label,i,0,1,5)
        ...
        self.BTN_Vp_Vs.setText('Click to Calculate Vp and Vs')
        ...
        self.label = QLabel()
        self.label.resize(100,50)
        self.label.setText('9. Make plots')
        self.label.setWordWrap(True)
        self.BTN_Minerals_layout.addWidget(self.label,i,0,1,6)
        ...
        self.label = QLabel()
        self.label.resize(100,50)
        self.label.setText('10. Add a reference model here')
        self.label.setWordWrap(True)
        self.BTN_Minerals_layout.addWidget(self.label,i,0,1,6)
...
#==============================================================================
    ...
    def plot_calculate_velosity(self):
        ...
        if self.Check_water.isChecked() == True and self.CheckRegression != [True,True,True]:
            name = ['olivine','wadsleyite','ringwoodite']
            print_name=''
            for num,i in enumerate(self.CheckRegression):
                if i == False:
                    print_name+=name[num]+' '
            message = 'Please check regression function in ' + print_name
            self.showdialog(message1=message,message2=message)
            return None
